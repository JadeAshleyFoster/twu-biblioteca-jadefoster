...
public class ConsoleUITest {
    ...
    //TODO:add more tests, one for each method
    ...
    public void testListOfBooks() {
        String output = testUI.getFormattedListOfItems(library.getBooks());
    ...
    public void testBookListColumnHeaders() {
        String output = testUI.getFormattedHeaders(Book.getColumnHeaders());
    ...
    public void testMovieListColumnHeaders() {
        String output = testUI.getFormattedHeaders(Movie.getColumnHeaders());
